...
RSpec.describe ReceiptPromotion do
  ...
  it "can link to a receipt line" do
    ...
    promotion = create_receipt_promotion(receipt: line.receipt, linked_line: line, linking_method: "parser_inferred")
  ...
  it "requires unallocated when no linked line is recorded" do
    promotion = create_receipt_promotion.tap { |record| record.linking_method = "parser_inferred" }
